...
public class LeshanClientDemo {
    ...
    private final static String[] modelPaths = new String[] { "5.xml", "Extel0001.xml",
            "3303.xml",
            "10250.xml", "10262.xml", "10263.xml",
            "10266.xml","10267.xml","10268.xml","10269.xml","10270.xml", "10271.xml" };

    private static final int OBJECT_ID_TEMPERATURE_SENSOR = 3303;

    private static final int OBJECT_ID_APP_DATA_CONTAINER = 10250;

    private static final int OBJECT_ID_INTERVAL_DATA_DELIVERY = 10262;
    private static final int OBJECT_ID_EVENT_DATA_DELIVERY = 10263;
    private static final int OBJECT_ID_WATER_FLOW_READINGS = 10266;
    private static final int OBJECT_ID_DAILY_MAX_WATER_FLOW_RATE_READINGS = 10267;
    private static final int OBJECT_ID_TEMPERATURE_READINGS = 10268;
    private static final int OBJECT_ID_PRESSURE_READINGS = 10269;
    private static final int OBJECT_ID_BATTERY_LEVEL_READINGS = 10270;
    private static final int OBJECT_ID_COMMUNICATION_ACTIVITY_TIME_READINGS = 10271;


    private static final int OBJECT_ID_EXTEL_TEST_DIAGNOTIC = 10888;

    private final static String DEFAULT_ENDPOINT = "LeshanClientDemo";
    private final static String USAGE = "java -jar leshan-client-demo.jar [OPTION]";

    private static OMA0006Location locationInstance;
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort,
        ...
        locationInstance = new OMA0006Location(latitude, longitude, scaleFactor);
        ...
        initializer.setClassForObject(DEVICE, OMA0003Device.class);
        initializer.setClassForObject(FIRMWARE, OMA0005FirmwareUpdate.class);

        initializer.setInstancesForObject(LOCATION, locationInstance);
        initializer.setInstancesForObject(OBJECT_ID_EXTEL_TEST_DIAGNOTIC, new Extel0001TestDiagnostic());
        initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_SENSOR, new OMA3303RandomTemperatureSensor());
        initializer.setInstancesForObject(OBJECT_ID_INTERVAL_DATA_DELIVERY, new OMA10272IntervalDataDelivery());
        initializer.setInstancesForObject(OBJECT_ID_EVENT_DATA_DELIVERY, new OMA10273EventDataDelivery());

        initializer.setInstancesForObject(OBJECT_ID_APP_DATA_CONTAINER, new OMA10250AppDataContainer());

        initializer.setInstancesForObject(OBJECT_ID_WATER_FLOW_READINGS, new OMA10266WaterFlowReadings());
        initializer.setInstancesForObject(OBJECT_ID_DAILY_MAX_WATER_FLOW_RATE_READINGS, new OMA10267DailyMaximumFlowRateReadings());
        initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_READINGS, new OMA10268TemperatureReadings());
        initializer.setInstancesForObject(OBJECT_ID_PRESSURE_READINGS, new OMA10269PressureReadings());
        initializer.setInstancesForObject(OBJECT_ID_BATTERY_LEVEL_READINGS, new OMA10270BatteryLevelReadings());
        initializer.setInstancesForObject(OBJECT_ID_COMMUNICATION_ACTIVITY_TIME_READINGS, new OMA10271CommunicationsActivityTimeReadings());


        List<LwM2mObjectEnabler> enablers = initializer.create(SECURITY, SERVER, FIRMWARE, DEVICE, LOCATION,
                OBJECT_ID_EXTEL_TEST_DIAGNOTIC,
                OBJECT_ID_APP_DATA_CONTAINER,
                OBJECT_ID_TEMPERATURE_SENSOR,
                OBJECT_ID_INTERVAL_DATA_DELIVERY, OBJECT_ID_EVENT_DATA_DELIVERY,
                OBJECT_ID_WATER_FLOW_READINGS, OBJECT_ID_DAILY_MAX_WATER_FLOW_RATE_READINGS, OBJECT_ID_TEMPERATURE_READINGS,
                OBJECT_ID_PRESSURE_READINGS, OBJECT_ID_BATTERY_LEVEL_READINGS, OBJECT_ID_COMMUNICATION_ACTIVITY_TIME_READINGS);

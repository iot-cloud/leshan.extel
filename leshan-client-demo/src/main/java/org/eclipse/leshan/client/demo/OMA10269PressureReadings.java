...
public class OMA10269PressureReadings extends BaseInstanceEnabler {
    private static final Logger LOG = LoggerFactory.getLogger(OMA10269PressureReadings.class);
    ...
    public OMA10269PressureReadings() {
    }

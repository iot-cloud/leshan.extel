...
public class OMA0006Location extends BaseInstanceEnabler {

    private static final Logger LOG = LoggerFactory.getLogger(OMA0006Location.class);
    ...
    public OMA0006Location() {
        this(null, null, 1.0f);
    }

    public OMA0006Location(Float latitude, Float longitude, float scaleFactor) {
        if (latitude != null) {

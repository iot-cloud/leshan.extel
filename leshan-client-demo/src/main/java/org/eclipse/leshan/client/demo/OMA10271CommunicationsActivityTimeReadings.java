...
public class OMA10271CommunicationsActivityTimeReadings extends BaseInstanceEnabler {
    private static final Logger LOG = LoggerFactory.getLogger(OMA10271CommunicationsActivityTimeReadings.class);
    ...
    public OMA10271CommunicationsActivityTimeReadings() {
    }

...
public class RegistrationEngine {
    ...
    //HNG private static final long DEFAULT_TIMEOUT = 100 * 60 * 1000l; // 2min in ms
    private static final long DEFAULT_TIMEOUT = 100 * 60 * 100000l; // 2min in ms
...
//                LinkFormatHelper.getClientDescription(objectEnablers.values(), null), additionalAttributes);
        ...
        RegisterRequest regRequest = new RegisterRequest(endpoint, new Long(2000), LwM2m.VERSION, dmInfo.binding, null,
                LinkFormatHelper.getClientDescription(objectEnablers.values(), null), additionalAttributes);
    ...
    private synchronized void scheduleUpdate(DmServerInfo dmInfo) {
        if (started) {
            ...
            //HNG long nextUpdate = dmInfo.lifetime * 900l;
            long nextUpdate = dmInfo.lifetime * 90000l;
